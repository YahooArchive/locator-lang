...
// * You can also access:
//   http://localhost:3000/demo/demo-lang-foo.js
...
//   or this:
//   http://localhost:3000/demo/demo-lang-foo_fr-fr.js
...
app.get('/:locatorBundle/:langBundle', function (req, res, next) {
    ...
    res.send({
        ...
        lang: reqLang,
        entries: locatorObj.getBundle(req.params.locatorBundle).lang[reqLang]
    });
});
